...
- Gamification
  ...
  - Inventory & Cosmetics
## Screenshots
| ![Learn Page](images/learn_page.png) | ![Multiple Choice](images/lesson_multiple_choice.png) | ![True False](images/lesson_true_false.png) | ![Videos](images/lesson_video.png) | ![Puzzles](images/puzzles.png) | ![Games](images/game_A.png) |
|---------------------------|----------------------------------------|----------------------------------|-----------------------------|-------------------------|------------------------|
